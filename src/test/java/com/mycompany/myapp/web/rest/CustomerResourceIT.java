...
public class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "n@to.c";
    private static final String UPDATED_EMAIL = "g&@Ff.z";
     ...
     *
     * @see com.mycompany.myapp.repository.search.CustomerSearchRepositoryMockConfiguration
     */
    @Autowired
